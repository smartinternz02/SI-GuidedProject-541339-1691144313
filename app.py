...
app = Flask(__name__)
app.secret_key = 'a'
conn=ibm_db.connect("DATABASE=bludb; HOSTNAME=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=30426;UID=qvr36039; PWD=VTp9zVSjqcBqWM4y; SECURITY=ssl; SSLSERVERCERTIFICATE=DigiCertGlobalRootCA.crt ",'','')
